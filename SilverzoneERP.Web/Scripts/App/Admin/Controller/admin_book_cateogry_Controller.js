...
(function (app) {
    ...
    bookCategory_list_Controllerfn.$inject = ['$scope', '$rootScope', '$uibModal', '$compile', 'admin_bookCategory_Service', 'signalRHubProxy'];

    function bookCategory_list_Controllerfn($sc, $rsc, $modal, $compile, bookSvc, hubSvc) {
        ...
        hubSvc.on('addCategory', function (data) {
            console.log(data);
        });
        ...
        function bind_advanceSearch_HTML() {
            ...
            setTimeout(function () {
                var $el = '<div id="advance_search_Box" class="col-md-6 pull-right" style="padding: 3px;margin: 3px;padding-left: 79px; display: none;">'
                          + ' <div class="col-md-6"><input type="search" class="form-control1" placeholder="Book Category Name" ng-model="book_category_advanceSerach.name"> </div>'
        ...
        $sc.Show_editModal = function (model) {
            ...
            var modalInstance = $modal.open({
                templateUrl: 'Templates/Admin/modal/book_categoryEdit.html',
    ...
    var bookCategory_create_Controllerfn = function ($sc, bookSvc, notificationService, hubSvc) {
        $sc.book_category = {};
    ...
    angular.module('Silverzone_admin_app')
        ...
        .controller('bookCategory_create', ['$scope', 'admin_bookCategory_Service', 'notificationService', 'signalRHubProxy', bookCategory_create_Controllerfn])
    ;
